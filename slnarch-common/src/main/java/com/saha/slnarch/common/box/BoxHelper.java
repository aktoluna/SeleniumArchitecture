package com.saha.slnarch.common.box;
...
public class BoxHelper {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length != 2) {
      ...
      System.out.println("");
      System.out
          .println("<app-info-file>: a JSON file with information about your API app.  Example:");
      System.out.println("");
      System.out.println("  {");
    ...
    try {
      ...
      System.out
          .println("Saved authorization information to \"" + output.getCanonicalPath() + "\".");
