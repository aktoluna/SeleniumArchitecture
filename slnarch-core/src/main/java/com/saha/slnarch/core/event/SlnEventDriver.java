package com.saha.slnarch.core.event;
...
public class SlnEventDriver implements WebDriver, JavascriptExecutor, TakesScreenshot,
  ...
  public SlnEventDriver(final WebDriver driver) {
   ...
   */
  public SlnEventDriver register(WebDriverEventListener eventListener) {
   ...
   * @return this for method chaining.
   */
  public SlnEventDriver unregister(WebDriverEventListener eventListener) {
  ...
  private Object unpackWrappedElement(Object arg) {
    if (arg instanceof List<?>) {
      ...
      return toReturn;
    } else if (arg instanceof SlnEventDriver.EventFiringWebElement) {
      return ((SlnEventDriver.EventFiringWebElement) arg).getWrappedElement();
    } else {
      return arg;
    }
  }
  ...
  private Object wrapResult(Object result) {
    if (result instanceof WebElement) {
      return new SlnEventDriver.EventFiringWebElement((WebElement) result);
    }
  ...
  public TargetLocator switchTo() {
    return new SlnEventDriver.EventFiringTargetLocator(driver.switchTo());
  }

  public Navigation navigate() {
    return new SlnEventDriver.EventFiringNavigation(driver.navigate());
  }

  public Options manage() {
    return new SlnEventDriver.EventFiringOptions(driver.manage());
  }

  private WebElement createWebElement(WebElement from) {
    return new SlnEventDriver.EventFiringWebElement(from);
  }
  ...
  private class EventFiringOptions implements Options {
    ...
    public Timeouts timeouts() {
      return new SlnEventDriver.EventFiringTimeouts(options.timeouts());
    }
    ...
    public Window window() {
      return new SlnEventDriver.EventFiringWindow(options.window());
    }
  }
  ...
  private class EventFiringTargetLocator implements TargetLocator {
    ...
    public Alert alert() {
      return new SlnEventDriver.EventFiringAlert(this.targetLocator.alert());
    }
  }
